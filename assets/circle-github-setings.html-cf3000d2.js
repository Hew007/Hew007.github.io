...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>提交代码，推送到github，circleci将开始按照配置的设置执行整个CI流程，执行成功完成后，打开github pages即可看到部署成功之后的内容。</p>`,25);function _(q,x){const a=o("ExternalLinkIcon");return c(),p("div",null,[d,r,m,l(" more "),k,v,g,n("p",null,[s("要使用circleci，需要先注册一个账户。进入"),n("a",b,[s("circleci官网"),e(a)]),s("，点击注册或者使用github账户进行注册登录。推荐使用github账户授权，下图即为github授权登录页面。")]),h,n("p",null,[s("config.yml文件遵循yaml语法，靠缩进来表示上下级关系，同样也使用键值对，比较简单。可以参考官方的"),n("a",y,[s("配置参考"),e(a)]),s("。下面是一个简单是config.yml示例。")]),f])}const C=i(u,[["render",_],["__file","circle-github-setings.html.vue"]]);export{C as default};
