...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>新版文档比之前质量要好很多，有更多例子以及原理性的说明，建议大家再通读一遍，定能有所收获。</p>`,5);function v(b,h){const a=l("ExternalLinkIcon");return o(),p("div",null,[s("p",null,[n("这个问题再hooks刚出现时就有了，最近翻阅官方文档时，发现新版的"),s("a",r,[n("React官方文档"),e(a)]),n("给出了详细的答案，并给出了伪代码实现，这里也做一个复习总结。")]),c(" more "),s("blockquote",null,[s("p",null,[n("在 React 内部，为每个组件保存了一个"),d,n("，其中每一项都是一个 state 对。它维护当前 state 对的索引值，在渲染之前将其设置为 “0”。每次调用 useState 时，React 都会为你提供一个 state 对并增加索引值。你可以在文章 "),s("a",k,[n("React Hooks: not magic, just arrays"),e(a)]),n("中阅读有关此机制的更多信息")])]),m])}const f=t(u,[["render",v],["__file","why-only-call-Hooks-at-the-top-level.html.vue"]]);export{f as default};
